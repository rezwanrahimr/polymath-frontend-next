                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-[#21262D]">
                                    <tr>
                                        <th className="text-left py-3 px-3 lg:px-6 text-gray-300 font-medium text-sm">Title</th>
                                        <th className="text-left py-3 px-3 lg:px-6 text-gray-300 font-medium text-sm">Date</th>
                                        <th className="text-left py-3 px-3 lg:px-6 text-gray-300 font-medium text-sm">Status</th>
                                        <th className="text-left py-3 px-3 lg:px-6 text-gray-300 font-medium text-sm">Niche</th>
                                        <th className="text-left py-3 px-3 lg:px-6 text-gray-300 font-medium text-sm">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            >
                                                <td className="py-3 px-3 lg:px-6">
                                                    <div className="flex items-center space-x-3">
                                                        <span className="text-white font-medium text-sm lg:text-base truncate max-w-[150px] lg:max-w-none">{history.title}</span>
                                                    </div>
                                                </td>
                                                <td className="py-3 px-3 lg:px-6">
                                                    <span className="text-gray-300 text-sm lg:text-base">{history.date}</span>
                                                </td>
                                                <td className="py-3 px-3 lg:px-6">
                                                ...
                                                <td className="py-3 px-3 lg:px-6">
                                                    <span className="text-gray-300 text-sm lg:text-base">{history.niche}</span>
                                                </td>
                                                <td className="py-3 px-3 lg:px-6">
                    ...
                    <div className="space-y-3">
                        {filteredData.length > 0 ? (
                            filteredData.map((history) => (
                                <div key={history.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50">
                                    <div className="flex justify-between items-start mb-3">
                                        <h3 className="text-white font-medium text-base flex-1 pr-2">{history.title}</h3>
                                        <span className={getStatusBadge(history.status)}>
                                            {history.status}
                                        </span>
                                    </div>
